...
try {
  ...
  try {
    ...
    console.log('🔄 删除旧 tag...');
    try { execSync(`git tag -d ${tag}`, { stdio: 'pipe' }); console.log('  ✓ 删除本地 tag'); } catch (e) {}
    try { execSync(`git push origin :refs/tags/${tag}`, { stdio: 'pipe' }); console.log('  ✓ 删除远程 tag'); } catch (e) {}
    try { execSync(`gh release delete ${tag} -y`, { stdio: 'pipe' }); console.log('  ✓ 删除旧 release'); } catch (e) {}
